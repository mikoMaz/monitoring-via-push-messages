...
public class DeviceDataController {
    ...
    public ResponseEntity<String> hello(
        ...
        if (deviceStatus == null) {
            ...
            if (status == 0) {
                historyService.save(DeviceHistory.builder().deviceId(pal.getDeviceId())
                        .end_timestamp(pal.getTimestamp()).start_timestamp(latestLoggedTime)
                        .length(pal.getTimestamp() - latestLoggedTime).build());
            }
